    ...
    <PageShell>
      ...
      <form onSubmit={submit} className="mt-8 space-y-6 mb-6 ">
        ...
        <div className="space-y-3">
          <button
            type="button"
            className="w-full rounded-lg border border-gray-200 px-4 py-3 font-medium flex items-center"
          >
            <span role="img" aria-label="g">
              <svg class="w-6 h-6 text-purple-800 dark:text-purple-800 mx-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
